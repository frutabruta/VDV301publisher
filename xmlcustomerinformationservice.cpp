...
QString XmlCustomerInformationService::AllData2_4(QVector<Spoj> seznamSpoju, QVector<Prestup> prestupy, CestaUdaje stav )
{
    qDebug()<<Q_FUNC_INFO;
    QVector<ZastavkaCil> docasnySeznamZastavek=seznamSpoju.at(stav.indexSpojeNaObehu).globalniSeznamZastavek;
    ...
    {
        qDebug()<<"nejsou zastavky";
        return "AllData2.4 nejsou zastavky";
    }
...
//rozpracovano
QString XmlCustomerInformationService::CurrentDisplayContent2_2CZ1_0(int poradi, QVector <ZastavkaCil> docasnySeznamZastavek, CestaUdaje stav )
{
    qDebug()<<"XmlCustomerInformationService::CurrentDisplayContent1_0";
    Zastavka cilovaZastavka;
    if (docasnySeznamZastavek.size()==0)
    ...
    dCurrentDisplayContentData.appendChild(DisplayContent2_2CZ1_0("CurrentDisplayContent",docasnySeznamZastavek,language,stav.indexAktZastavky,stav.indexAktZastavky));
    dCustomerInformationService.appendChild(dCurrentDisplayContentData);
    xmlko.appendChild(dCustomerInformationService);
...
//rozpracovano
QString XmlCustomerInformationService::CurrentDisplayContent2_4(int poradi, QVector <ZastavkaCil> docasnySeznamZastavek, CestaUdaje stav )
{
    qDebug()<<"XmlCustomerInformationService::CurrentDisplayContent1_0";
    Zastavka cilovaZastavka;
    if (docasnySeznamZastavek.size()==0)
